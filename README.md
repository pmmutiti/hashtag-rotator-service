...
<body>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td>hashtag-rotator.js</td><td>✅ Deployed</td><td>Just now</td><td>civic-endpoint-verified</td></tr>
  ...
  <ul>
    ...
    <li>🧠 Canonical endpoint: <code>/api/hashtag-rotator</code></li>
    <li>🚫 Fallback logic disabled — verified civic signals only</li>
  </ul>
...
&lt;/a&gt;</code></pre>
  ...
  "timestamp": "2025-08-26T10:42:00Z",
  "regionsSupported": ["kenya", "nigeria", "usa", "uk", "india"],
  "endpoint": "/api/hashtag-rotator",
